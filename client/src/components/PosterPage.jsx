      ...
      <div className='px-5 pt-5 flex flex-col justify-center items-center h-full'>
        ...
        <div className='z-10'>
          <div className='text-center mt-20'>
            <h1 className='w-full md:w-[600px] text-white text-3xl md:text-5xl font-quintessential'>
              {' '}
              {details.title}{' '}
            </h1>
            <h2 className='font-comforter text-7xl md:text-9xl -mt-3 text-gold'>
              {details.subtitle}
            </h2>
          </div>
          ...
          {!soldOut && (
            <div className='w-full mt-20'>
              <div className='flex flex-col w-full justify-center items-center mx-2 -mr-20'>
                {details.on_sale && (
                  <div
                    className='text-white px-5 py-2 m-5 text-2xl
