...
let workerBlob = createBlob(['./worker.js'], {
...
export default class QrReader extends Component {
  ...
  handleVideo(stream) {
    ...
    this.setState({ mirrorVideo: facingMode === 'environment', streamLabel: streamTrack.label })
  }
  handleLoadStart() {
    ...
    return (
      <section className={className} style={style}>
        <section style={containerStyle}>
          ...
          {
            legacyMode
              ? <img style={imgPreviewStyle} ref={this.setRefFactory('img')} onLoad={onImageLoad}  alt=''/>
