...
const stripePromise = loadStripe(
  'pk_test_51KOpn6BRR1XWE4vwWeOgGvIsFANKoOnoN4o9PeDBXATtnx0CB5MYyF54XN89wBZLvnwn8O2NGFe9zDQfN9HvN59I00v4hWAIsJ'
);
  ...
  return (
    <div className='text-white w-full'>
      <div className='flex'>
          ...
          <div className='p-20' id='PurchasePage'>
              ...
              <div className='-ml-2'>
                ...
                >
                  ...
                  <div>
                    ...
                    <TextField required type='email' label='Confirm Email' />
                  </div>
                </Box>
              </div>
            </div>
            ...
            <div className='w-[97%] mt-10 drop-shadow'>
              ...
              <p className='text-sm p-5 w-[80%]'>
                By clicking "Pay Now", I accept the Terms of Service and have read the Privacy
                Policy.
              </p>
        ...
        <div className='w-[30%] flex bg-[#fff]'></div>
      </div>
