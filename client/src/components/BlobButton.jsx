const BlobButton = ({text, textColor, className}) => {
    return (
        <svg className={`${className} blob-svg`} viewBox="45 60 400 320" xmlns="http://www.w3.org/2000/svg">
            ...
            <mask id="knockout-text">
                ...
                <text x="147" y="227" fill={textColor || "#000"}>{text}</text>
            </mask>
        </svg>
    )
}
